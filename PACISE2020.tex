...
trying to summarize with the exhaustive algorithm. We executed this code through
a Jupyter Notebook running within a Docker container on a system exposing one
core of an Intel Xeon 6140 and 16Gb of RAM to the virtualized system.
...
presented in Figure~\ref{fig:extractive}. The scores were produced using the TF-IDF weighting metric as it incorporated additional, meaningful analysis into the
