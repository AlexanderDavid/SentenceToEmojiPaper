...
\begin{equation}
  \textrm{Average score weighted by
    TF-IDF} = \frac{\sum_{i=1}^kw_i\times s_i}{\sum_{i=1}^kw_i}\label{eq:averageTF-IDFScore}
\end{equation}
...
\begin{figure}[H]
  \begin{center}
    ...
    \caption{{Results from the exhaustive n-gram generation algorithm
...
\caption{{Results from the dependency tree n-gram generation algorithm
